...
const VideoList = ({ video }: { video: Video[] }) => {
    ...
    return (
        <div className="w-full overflow-x-auto scrollbar-hide">
            <table className='min-w-225 w-full table-fixed'>
                ...
                <tbody>
                    {video.map((video) => (
                        <tr key={video.id} className='border-b border-slate-500 h-20'>
                                ...
                                <div className="group flex gap-2 h-full items-center">
                                    ...
                                    <div className="hidden group-hover:flex flex-col flex-1 min-w-0">
                                        <div className="flex w-full h-6">
                                            <p className="text-md font-semibold line-clamp-2 wrap-break-word hover:underline">
                                                {video.title}
                                            </p>
                                        </div>
